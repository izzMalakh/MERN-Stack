...
<html lang="en">
  ...
  <body id="body">
    ...
    <p onmouseover="mouseOverFunction(this)">
      ...
      anywhere in this paragraph tag and I want to be able to change the
      background color to whatever is in this input:
      <input id="zaki" type="text" />.
    </p>
    <script>
      ...
      mouseOverFunction = (el) => {
        zakiColor = zaki.value;
        console.log(zakiColor);
        el.style = "background-color:" + zakiColor;
      };
    </script>
  </body>
</html>